...
if (isset($_REQUEST["evento"]) && $_REQUEST["evento"] == "borrar") {
    ...
    $mensaje = "El usuario con id: {$_REQUEST['id']} y usuario {$_REQUEST["usuario"]} con nombre {$_REQUEST["name"]} Borrado correctamente";
    if (isset($_REQUEST["error"])) {
        $clase = "alert alert-danger ";
        $mensaje = "ERROR!!! No se ha podido borrar el usuario con id: {$_REQUEST['id']}  y usuario {$_REQUEST["usuario"]} con nombre {$_REQUEST["name"]}";
    }
}
